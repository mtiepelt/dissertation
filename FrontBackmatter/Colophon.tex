...
%
The thesis was written using \emph{Sublime Text}\footnote{\url{https://www.sublimetext.com/}} with the \emph{LatexTools} Plugin, 
many of the graphics were build using \emph{Ipe}\footnote{\url{https://ipe.otfried.org/}}. 
%
The writing process was supported by the \emph{write-good} linter\footnote{\url{https://www.npmjs.com/package/write-good}} with the corresponding Sublime Text plugin\footnote{\url{https://github.com/btford/write-good}}.
%
Additionally, 
\emph{Thesaurus}\footnote{\url{https://www.thesaurus.com/}} and \emph{DeepL}\footnote{\url{https://www.deepl.com/de/write}} were used to improve the wording of individual paragraphs. 
